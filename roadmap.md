# Barbaresco site roadmap

- [ ] Add restaurant logo (uploaded) to nav/hero/footer
- [ ] Full interactive menu from the PDF (all items, categories, filter/expand) + "View PDF" button
